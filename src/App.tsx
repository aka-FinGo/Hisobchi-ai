        ...
        <div className="block-3d rounded-[24px] h-[70px] flex justify-between items-center relative px-2 neon-border-thin">
          ...
          <div className="relative w-16 flex justify-center">
            <button
              ...
              className="absolute -top-10 w-16 h-16 rounded-full bg-gradient-to-b from-orange-500 to-amber-700 text-white flex items-center justify-center shadow-[0_0_20px_rgba(249,115,22,0.4)] border-[4px] border-zinc-900 active:scale-90 transition-transform z-50"
            >
